...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "JohnJanzenCOSC295Assignment2.Android.dll" comes first in this list. */
		"JohnJanzenCOSC295Assignment2.Android.dll",
		"FormsViewGroup.dll",
		"JohnJanzenCOSC295Assignment2.dll",
		"SQLite-net.dll",
